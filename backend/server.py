...
CORS_ORIGINS = os.getenv("CORS_ORIGINS", f"http://localhost:{os.getenv('FRONTEND_PORT', '5173')},http://localhost:{os.getenv('PORT', '8002')},http://localhost:{os.getenv('ALT_PORT', '3000')}").split(",")
